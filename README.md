...
Дополнительно выполнена реализация "легкой" версии проекта без сторонних ресурсов  в google colab с использованием - Multi-Object Tracking with Ultralytics YOLO.
...
![Traffic statistics_1](video_out/result_video.mp4)
